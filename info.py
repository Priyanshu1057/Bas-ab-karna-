...
ADMINS = [
    ...
    for admin in environ.get("ADMINS", "1018033649").split()
]
OWNER_USERNAME = environ.get(
    "OWNER_USERNAME", "Matt_4565"
)  # without @ or https://t.me/
USERNAME = environ.get("USERNAME", "Matt_4565")  # ADMIN USERNAME
...
AUTH_REQ_CHANNEL = int(environ.get("AUTH_REQ_CHANNEL", "-1002865357864"))
LOG_CHANNEL = int(environ.get("LOG_CHANNEL", "-1002929455374"))
LOG_API_CHANNEL = int(environ.get("LOG_API_CHANNEL", "0"))
LOG_VR_CHANNEL = int(environ.get("LOG_VR_CHANNEL", "0"))

# MongoDB
DATABASE_URI = environ.get("DATABASE_URI", "mongodb+srv://duopoly2k25_db_user:bgUrUROlpihe8HgE@cluster0.ccykc6h.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
DATABASE_NAME = environ.get("DATABASE_NAME", "Cluster0")

# Files index database url
FILES_DATABASE = environ.get("FILES_DATABASE", "mongodb+srv://sudemewo_db_user:eJl2eAQ6m3v1H5aa@cluster0.kmauid4.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
COLLECTION_NAME = environ.get("COLLECTION_NAME", "jisshu")

# Other Channel's
SUPPORT_GROUP = int(environ.get("SUPPORT_GROUP", "-1002824228432"))
DELETE_CHANNELS = int(environ.get("DELETE_CHANNELS", "-1002756257415"))
...
SUPPORT_CHAT = environ.get("SUPPORT_CHAT", "https://t.me/FilmyflixHDsupportgroup")
MOVIE_GROUP_LINK = environ.get("MOVIE_GROUP_LINK", "https://t.me/+KhoiHtUJz_tkNGQ1")
